...
- main:
  ...
  - complementary:
    ...
    - paragraph: "Последнее сохранение: 25.08, 10:37"
    - button "Очистить черновик"
  - button "Основная информация" [expanded]
  ...
  - button "Фото рецепта Обложка и дополнительные изображения."
  - button "Категории Выбери один или несколько подходящих разделов."
  - button "Теги Добавь слова, по которым рецепт будет проще найти."
  - button "Ингредиенты Структурированный список для пересчёта порций."
  - button "Текстовые ингредиенты Свободный список без автоматического пересчёта."
  - button "Шаги Последовательность приготовления блюда."
  - button "Связанные рецепты Блюда, которые удобно готовить вместе или использовать как основу."
  - button "КБЖУ Ручные значения для всего рецепта или расчёт по связанным продуктам."
  - text: Нужно дозаполнить
